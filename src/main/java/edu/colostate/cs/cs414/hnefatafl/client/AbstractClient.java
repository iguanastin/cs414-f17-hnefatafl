package edu.colostate.cs.cs414.hnefatafl.client;// This file contains material supporting section 3.7 of the textbook:
...
/**
 * The <code> client.AbstractClient </code> contains all the methods necessary to set
...
// end of client.AbstractClient class