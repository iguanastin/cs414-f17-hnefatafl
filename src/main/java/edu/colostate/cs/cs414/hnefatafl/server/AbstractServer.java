package edu.colostate.cs.cs414.hnefatafl.server;// This file contains material supporting section 3.8 of the textbook:
...
/**
 * The <code> server.AbstractServer </code> class maintains a thread that waits
 * for connection attempts from clients. When a connection attempt occurs
 * it creates a new <code> server.ConnectionToClient </code> instance which
...
public abstract class AbstractServer implements Runnable {
     ...
     * thread group is a <code> server.ConnectionToClient </code>.
     */
...
// CONSTRUCTOR ******************************************************
    ...
    public AbstractServer(int port) {
        ...
        this.clientThreadGroup = new ThreadGroup("server.ConnectionToClient threads") {
...
// ACCESSING METHODS ------------------------------------------------
     ...
     * <code>server.ConnectionToClient</code> instances.
     */
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
     ...
     * server.ConnectionToClient thread.
...
// METHODS TO BE USED FROM WITHIN THE FRAMEWORK ONLY ----------------
     ...
     * Called by the run method of <code>server.ConnectionToClient</code>
...
// End of server.AbstractServer Class
